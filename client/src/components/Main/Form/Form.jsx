...
import { pajamuKategorijos, islaiduKategorijos } from '../../../constans/categories';
...
const Form = () => {
    ...
    const selectedCategories =  formData.type === 'Pajamos' ? pajamuKategorijos : islaiduKategorijos;
  ...
  return (
    <Grid container spacing={2}>
        ...
        <Grid item xs={6}>
            <FormControl fullWidth>
                ...
                <Select value={formData.type} onChange={(e) => setFormData({ ...formData, type: e.target.value })}>
                    ...
                    <MenuItem value="Islaidos">Išlaidos</MenuItem>
                </Select>
            </FormControl>
        </Grid>
        <Grid item xs={6}>
        ...
        <Button className={classes.button} variant='outlined' color="primary" fullWidth onClick={createTransaction}>Sukurti</Button>
  </Grid>
  )
};
